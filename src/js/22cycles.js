...
/*
do {
    console.log(num);       // сначала выполняем действие
    num++;
}
...
/*
for (let i = 1; i < 8; i++) {
    console.log(i);           // сначала выполняем действие. Любая часть for может быть пропущена
}

// for (начало; условие; шаг) {   //Выполнить начало  → (Если условие == true → Выполнить тело, Выполнить шаг)...
//    ... тело цикла ...
// }
 */
...
/*
let result = '';   // результат, который будем выводить (строка)
